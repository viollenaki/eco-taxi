...
static constexpr auto qt_meta_stringdata_ZN17navigationManagerE = QtMocHelpers::stringData(
    "navigationManager",
    "reload",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17navigationManagerE[] = {
...
Q_CONSTINIT const QMetaObject navigationManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17navigationManagerE.offsetsAndSizes,
    qt_meta_data_ZN17navigationManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17navigationManagerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<navigationManager, std::true_type>,
        // method 'reload'
...
void *navigationManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17navigationManagerE.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "nm"))
        return static_cast< nm*>(this);
    if (!strcmp(_clname, "alxnko.nm"))
        return static_cast< nm*>(this);
