...
static constexpr auto qt_meta_stringdata_ZN12CalendarPageE = QtMocHelpers::stringData(
    "CalendarPage",
    "changeDate",
    "",
    "date",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12CalendarPageE[] = {
...
Q_CONSTINIT const QMetaObject CalendarPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12CalendarPageE.offsetsAndSizes,
    qt_meta_data_ZN12CalendarPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12CalendarPageE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CalendarPage, std::true_type>,
        // method 'changeDate'
...
void CalendarPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (CalendarPage::*)(QDate );
            if (_q_method_type _q_method = &CalendarPage::changeDate; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *CalendarPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12CalendarPageE.stringdata0))
...
// SIGNAL 0
void CalendarPage::changeDate(QDate _t1)
{
